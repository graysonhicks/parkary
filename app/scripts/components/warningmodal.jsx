          ...
          <Modal.Dialog>
            ...
            <Modal.Body>
              <div className="not-logged-in-container">
                <h3 className="not-logged-in-heading">Sorry! <i onClick={this.props.cancelReview} className="fa fa-times pull-right close-login-notice-btn" aria-hidden="true"></i></h3>
